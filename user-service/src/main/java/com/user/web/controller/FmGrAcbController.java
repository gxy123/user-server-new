 ...
 */
@RestController
@RequestMapping("/user/fmgracb")
@Slf4j
public class FmGrAcbController extends BaseControllerImpl<FmGrAcbDO, FmGrAcbQueryDO> {

    @Autowired
    private FmGrAcbService baseService;

    @Override
    public BaseServiceAO<FmGrAcbDO, FmGrAcbQueryDO> getService() {
        return baseService;
    }
    ...
    public CommonResult<List<FmGrAcbDO>> select(@ModelAttribute("pojo") FmGrAcbQueryDO q) {
        CommonResult<List<FmGrAcbDO>> query = getService().query(q);
    ...
    @RequestMapping("get")
    public CommonResult<FmGrAcbDO> detail(@RequestParam("id") Long id) {
    ...
    public CommonResult<Long> update(@ModelAttribute("pojo") FmGrAcbDO t) {
    ...
    @RequestMapping("add")
    public CommonResult<FmGrAcbDO> insert(@RequestBody FmGrAcbDO t) {
